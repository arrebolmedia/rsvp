          ...
          >
            <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="sticky top-0 bg-gradient-to-r from-accent-wine to-accent-terracotta text-white p-8 flex justify-between items-center">
                <h2 className="font-elegant text-3xl md:text-4xl">Confirmar Asistencia</h2>
                <button
                  onClick={onClose}
              ...
              <div className="p-8">
                {success ? (
                  ...
                  >
                    ...
                    <h3 className="font-elegant text-3xl text-foreground mb-4">
                  ...
                  <>
                    <div className="mb-8 p-6 border border-subtle">
                      <h3 className="font-elegant text-2xl text-foreground mb-3">

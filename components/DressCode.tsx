      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="border-2 border-subtle p-8 md:p-12">
            <div className="mb-10">
              <div className="flex justify-center gap-6 mb-8 text-5xl text-accent-terracotta">
                <Icon1 />
                <Icon2 />
              </div>
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-6 text-sm text-foreground/70">
              <div className="flex flex-col items-center gap-3">
                <Icon1 className="text-3xl text-accent-terracotta" />
              ...
              <div className="flex flex-col items-center gap-3">
                <Icon3 className="text-3xl text-accent-terracotta" />

    ...
    <section className="py-20 px-4 bg-white">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-foreground/80 leading-relaxed mb-8 font-light">
          Nos complace invitarte a celebrar uno de los días más especiales de nuestras vidas.
        </p>
        <p className="text-base md:text-lg text-foreground/70 leading-relaxed font-light">
          Después de años de amor y complicidad, hemos decidido dar el siguiente paso en nuestra historia juntos. 
          Queremos compartir este momento único contigo y con las personas que más queremos.
        </p>
      </motion.div>
    </section>
  )
